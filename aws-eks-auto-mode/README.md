...
Run the following commands to deploy the storage classes and node pools. If you want to modify the zones change it in `aws-eks-auto-mode-node-pools-graviton.yml`
```
